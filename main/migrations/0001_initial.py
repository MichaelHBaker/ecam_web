# Generated by Django 5.1.1 on 2025-01-15 01:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='measurements', to='main.measurementtype')),
                ('unit', models.ForeignKey(help_text='Unit for this measurement', on_delete=django.db.models.deletion.PROTECT, to='main.measurementunit')),
            ],
        ),
        migrations.AddField(
            model_name='location',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timestamp', models.DateTimeField(db_index=True, help_text="Timestamp as received from source (interpreted using measurement's source_timezone)")),
